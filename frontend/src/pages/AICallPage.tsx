...
export default function AICallPage() {
  ...
  // Get session details from location state or localStorage
  const sessionId =
    location.state?.sessionId || localStorage.getItem("openai_session_id");
  ...
  useEffect(() => {
    ...
    if (!sessionId) {
      toast.error("No session information found");
              ...
              <div className="w-full h-[600px] flex items-center justify-center bg-white/95 dark:bg-gray-800/95 rounded-lg border border-gray-200 dark:border-gray-700">
                <div className="text-center">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Preparing your AI conversation...
                  </p>
                </div>
              </div>
            ) : (
